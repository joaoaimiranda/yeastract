...
export default function Layout() {
  ...
  function handleSearch(event) {
    ...
    if (searchFormData.trim() !== "") {
      ...
      // console.log(res);
      navigate(`/${species}/advanced-search?term=${searchFormData.trim()}`);
    }
  }
    ...
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content">
        <div className="flex flex-row gap-2 px-1 items-center">
          ...
          <h1 className="text-2xl font-figtree mt-1 lg:hidden">YEASTRACT+</h1>
        </div>
        ...
        <div className="flex flex-col p-5 h-screen bg-primary max-w-60">
          ...
          <ul className="menu w-full gap-1 text-lg p-0">
            <li>
              <a
                className={`text-color ${
                  currentPage() === species ? "active-tab" : ""
                }`}
                href={`/${species}`}
              >
                Regulations
            ...
            <li>
              <a
                className={`text-color ${
                  currentPage() === "sequences" ? "active-tab" : ""
                }`}
