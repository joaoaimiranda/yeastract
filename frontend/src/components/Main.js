    ...
    return (
        <form onSubmit={handleQuery}>
            <div className="formgrid grid">
                <div className="field col p-float-label">
                    <InputTextarea
                        id="tfs"
                        name="tfs"
                        onChange={handleForm}
                ...
                <div className="field col">
                    <div>
                        <RadioButton
                            id="documented"
                            name="evidence"
                            checked={formData.evidence === "documented"}
                            onChange={handleForm}
                        />
                        <label htmlFor="documented">Documented</label>
                    </div>
                    <div>
                        <RadioButton
                            id="binding"
                    ...
                    <div>
                        <RadioButton
                            ...
                            onChange={handleForm}
                        />
                        <label htmlFor="binding or expression">
                    ...
                    <div>
                        <RadioButton
                            ...
                            onChange={handleForm}
                        />
                        <label htmlFor="binding and expression">
                    ...
                    <div>
                        <RadioButton
                            id="potential"
                            name="evidence"
                            checked={formData.evidence === "potential"}
                            onChange={handleForm}
                        />
